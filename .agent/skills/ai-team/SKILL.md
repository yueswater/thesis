---
name: ai-team
description: Use when the user wants Codex and Claude Code to discuss this thesis project together, critique each other, and produce one final research plan.
---

# AI Team Skill

You are the entry point for a local Codex + Claude Code thesis team.
...
2. Do not solve the task alone unless the user explicitly asks you not to run the team.
