...
在 $S S$ 與 $U I$ 制度下，不知情者的行動不會接收到來自知情者的投入訊號：前者同時行動，後者由不知情者先動。在 $I U$ 制度下，知情者的投入雖然會被不知情者觀察，形式上可引發關於 $V_I$ 的後驗信念；但本文的關鍵設定是，不知情者的獎酬固定為 $V$，其最佳反應只依賴已觀察到的投入與自身獎酬，而不依賴對 $V_I$ 的後驗信念。因此，相較於 #c("fu2006")，本文保留相同的時序制度，卻關閉了「訊號--信念--反應」通道。
